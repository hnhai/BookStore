package com.framgia.bookStore.repository.impl;

import com.framgia.bookStore.entity.AbstractEntity;
import com.framgia.bookStore.repository.CustomJpaRepository;
...
@NoRepositoryBean
public class GenericJpaRepository<E extends AbstractEntity, ID extends Serializable> extends SimpleJpaRepository<E, ID> implements CustomJpaRepository<E, ID> {
    ...
    public long countByDeleted(boolean deleted) {
        return count(isDeleted(deleted));
    }
    ...
    @SuppressWarnings("NullableProblems")
    private static final class ByIdSpecification<T extends AbstractEntity, ID extends Serializable> implements Specification<T> {
    ...
    @SuppressWarnings("NullableProblems")
    private static final class ByIdsSpecification<T extends AbstractEntity, ID extends Serializable> implements Specification<T> {
