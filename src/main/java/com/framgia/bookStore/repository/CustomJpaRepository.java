...
@NoRepositoryBean
public interface CustomJpaRepository<E extends AbstractEntity, ID extends java.io.Serializable> extends JpaRepository<E, ID>, JpaSpecificationExecutor<E> {

    /**
     * Returns the number of instances that the given deleted flag will return.
     *
